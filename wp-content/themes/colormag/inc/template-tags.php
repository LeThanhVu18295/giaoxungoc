...
if ( ! function_exists( 'colormag_social_links' ) ) :
	...
	/**
	 * Displays the social links on the hearder menu.
	 */
	function colormag_social_links_on_hearder_menu() {
		...
		?>
			...
			foreach ( $colormag_social_links as $key => $value ) {
				...
				if ( ! empty( $link ) ) {
					$colormag_links_output .= '<div class="top-search-wrap">';
					$new_tab = '';
			...
			<div class="inner-wrap clearfix">
				...
				<?php if ( 1 == $random_post_icon || 1 == $search_icon ) { ?>
					<div class="search-random-icons-container">
						...
						if ( 1 == $social_links_enable) {
							colormag_social_links_on_hearder_menu();
						}
